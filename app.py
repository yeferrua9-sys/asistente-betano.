...
st.info(
    ...
    "cuando existen simultáneamente: "
    "histórico suficiente + modelo válido + "
    "evento coincidente + mercado ML real."
)
```
...
🟢 Eventos de mercado obtenidos desde
Odds-API.io.
...
🟢 Edge = probabilidad propia − probabilidad implícita.
